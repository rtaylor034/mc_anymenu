...
$data modify storage amenu:var attach.shadowed_menu set from storage amenu:var attach.existing_host.menus[{index:$(i)}]
...
$data modify storage amenu:var attach.existing_host.menus[{index:$(i)}] set from storage amenu:var attach.shadowed_menu
