...
data modify storage gssen:in difference.a set from storage amenu:var iter.current_items
data modify storage gssen:in difference.b set from storage amenu:var iter.current.internal.prev_items
